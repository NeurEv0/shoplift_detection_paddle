"""Evaluate a person-attribute checkpoint on a dataset split."""
...
from shoplift.models.person_attribute.train import _run_epoch
...
def evaluate(
    ...
    *,
    ...
    metrics = _run_epoch(model, loader, optimizer=None)
